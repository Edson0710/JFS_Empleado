...
public class NuevasAdapter extends RecyclerView.Adapter<NuevasAdapter.MyViewHolder> {
    ...
    public NuevasAdapter(Context mContext, List<Oferta> mData) {
        this.mContext = mContext;
        this.mData = mData;
    }

    @Override
    public NuevasAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {

        View view;
        view = View.inflate(mContext, R.layout.item_nuevas, null);

        final NuevasAdapter.MyViewHolder viewHolder = new NuevasAdapter.MyViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final NuevasAdapter.MyViewHolder holder, final int position) {
